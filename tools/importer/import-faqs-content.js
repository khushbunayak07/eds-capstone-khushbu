...
const PAGE_TEMPLATE = {
  name: 'faqs-content',
  description: 'FAQs content page: page title, intro, and an accordion of question/answer pairs.',
  urls: [
  ...
  sections: [
    {
      id: 'rc1', name: 'FAQs Title', selector: '.title.cmp-title',
      style: null, blocks: [], defaultContent: ['.title.cmp-title'],
    },
    {
      id: 'rc4', name: 'FAQ Accordion', selector: '.accordion.panelcontainer',
      style: null, blocks: ['accordion-faq'], defaultContent: [],
    },
  ],
};
